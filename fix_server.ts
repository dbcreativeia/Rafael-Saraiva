...
// find the next route which is app.delete('/api/imported-leads/campaign/:name'
const nextRouteIdx = content.indexOf(`app.delete('/api/imported-leads/campaign/:name'`);
