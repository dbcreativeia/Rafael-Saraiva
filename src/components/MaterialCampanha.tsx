...
export const MaterialCampanha = () => {
  ...
  useEffect(() => {
    trackEvent('PageView_MaterialCampanha');
  }, []);
          ...
          {!isSubmitted ? (
            <div className="p-8">
              <div className="flex flex-col md:flex-row gap-6 mb-10">
                ...
                >
                  <ImagePlus className={`w-12 h-12 mx-auto mb-4 ${tipoMaterial === 'foto' ? 'text-orange-500' : 'text-gray-400'}`} />
                  <h3 className={`text-xl font-black uppercase mb-2 ${tipoMaterial === 'foto' ? 'text-orange-600' : 'text-gray-600'}`}>Foto de Perfil</h3>
                ...
                >
                  <Download className={`w-12 h-12 mx-auto mb-4 ${tipoMaterial === 'digital' ? 'text-orange-500' : 'text-gray-400'}`} />
                  <h3 className={`text-xl font-black uppercase mb-2 ${tipoMaterial === 'digital' ? 'text-orange-600' : 'text-gray-600'}`}>Material Digital</h3>
                  <p className="text-gray-500 text-sm font-medium">Baixe agora mesmo artes para WhatsApp, Instagram e Facebook.</p>
                </button>
              </div>
              ...
              {tipoMaterial === 'foto' ? (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all font-medium"
                        placeholder="Seu nome"
                      />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2 uppercase">Sobrenome *</label>
                    <div className="relative">
                      <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
                      <input
                        type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2 uppercase">WhatsApp *</label>
                    <div className="relative">
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2 uppercase">E-mail *</label>
                    <div className="relative">
                ...
                <div className="pt-6 border-t border-gray-100">
                  <div className="mb-6">
                    ...
                    {tipoMaterial === 'impresso' && (
                      <div className="bg-yellow-50 text-yellow-800 px-4 py-3 rounded-lg border border-yellow-200 inline-flex items-center gap-2">
                        <Shield className="w-5 h-5 shrink-0 text-yellow-600" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <label className="block text-sm font-bold text-gray-700 uppercase">CEP *</label>
                        {cepLoading && (
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:border-transparent transition-all font-medium ${
                          cepError ? 'border-red-400 focus:ring-red-400 bg-red-50/30' : cepValid === true ? 'border-green-400 focus:ring-green-400' : 'border-gray-200 focus:ring-orange-500'
                        }`}
                    ...
                    <div className="md:col-span-2">
                      <label className="block text-sm font-bold text-gray-700 mb-2 uppercase">Endereço *</label>
                      <input
                        type="text"
                        required
                        value={formData.endereco}
                        onChange={e => setFormData({...formData, endereco: e.target.value})}
                        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all font-medium"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-2 uppercase">Número *</label>
                      <input
                        type="text"
                        required
                    ...
                    <div className="md:col-span-3">
                      <label className="block text-sm font-bold text-gray-700 mb-2 uppercase">Complemento</label>
                      <input
                        type="text"
                ...
                {tipoMaterial === 'impresso' && (
                  <div className="pt-6 border-t border-gray-100">
                    <div className="flex items-start gap-4 p-4 bg-orange-50 rounded-xl border border-orange-200">
                      ...
                      />
                      <label htmlFor="adesivoPerfurado" className="text-sm text-orange-900 font-bold leading-relaxed">
                ...
                <div className="pt-6 border-t border-gray-100">
                  <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                    <input
                      ...
                      className="mt-1 w-5 h-5 text-orange-500 rounded focus:ring-orange-500"
                    />
                    <label htmlFor="lgpd" className="text-sm text-gray-700 font-medium leading-relaxed">
                      Estou de acordo em fornecer meus dados e aceito os termos da <Link to="/politica-de-privacidade" className="font-bold text-orange-500 hover:underline" >Lei Geral de Proteção de Dados (LGPD) e a Política de Privacidade</Link>.
                    </label>
                  </div>
                </div>
                ...
                <button
                  ...
                  type="submit"
                  className="w-full bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white font-black uppercase tracking-widest text-xl py-5 rounded-2xl transition-all shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 transform hover:-translate-y-1"
                >
                  {isSubmitting ? (
            ...
            >
              ...
              <h2 className="text-3xl font-black text-gray-800 uppercase mb-4">Solicitação Concluída!</h2>
              <p className="text-xl text-gray-600 mb-8 max-w-lg font-medium">
                {tipoMaterial === 'impresso' 
